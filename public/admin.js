...
function addMatchField(team1 = '', team2 = '', time = '', court = '1') {
    ...
    div.innerHTML = `
        <select class="upcoming-team1 team-dropdown" style="background: ${getRandomTeamColor()}; font-family: 'Luckiest Guy'">
        </select>
        <span style="font-family: 'Shadows Into Light'">vs</span>
        <select class="upcoming-team2 team-dropdown" style="background: ${getRandomTeamColor()}; font-family: 'Luckiest Guy'">
        </select>
    ...
    populateDropdowns(); // Populate dropdowns after adding the field
}
